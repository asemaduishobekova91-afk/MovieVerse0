...
from site_app.database.models import Chat
from site_app.database.schema import ChatInputSchema, ChatOutSchema
...
async def update_chat(chat_id: int, chat: ChatInputSchema,
