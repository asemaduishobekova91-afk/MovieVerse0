...
from .serializers import (UserProfileListSerializer,UserProfileDetailSerializer,CategoryListSerializer,
                          CategoryDetailSerializer,StoreListSerializer,StoreDetailSerializer,StoreCreateSerializer,
                          OrderSerializer,CourierProductSerializer,
                          ReviewCreateSerializer,OrderStatusSerializer,UserProfileRegisterSerializer,UserProfileLoginSerializer)
...
from .permissions import CheckRolePermissions, CheckCourierPermissions,CreateStorePermissions
...
class StoreViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [CreateStorePermissions]
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, CheckRolePermissions]
...
class CourierProductViewSet(viewsets.ModelViewSet):
    ...
    permission_classes = [CheckCourierPermissions]
