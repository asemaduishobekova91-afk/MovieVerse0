...
class Store(models.Model):
    category_name = models.ForeignKey(Category, on_delete=models.CASCADE, related_name='category_stores')
    ...
    def get_avg_procent(self):
        ...
        if ratings.count() != 0:
            procent = round((count_person * 100) / ratings.count(), 1)
            return f"{procent}%"
...
class Product(models.Model):
    store = models.ForeignKey(StoreMenu, on_delete=models.CASCADE, related_name='menu_product')
