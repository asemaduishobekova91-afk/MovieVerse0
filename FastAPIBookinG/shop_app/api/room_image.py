...
from shop_app.database.models import RoomImage
from shop_app.database.schema import RoomImageInputSchema,RoomImageOutSchema
from shop_app.database.db import SessionLocal
from sqlalchemy.orm import Session
from typing import List


room_image_router = APIRouter(prefix='/room_image', tags=['room_image'])
